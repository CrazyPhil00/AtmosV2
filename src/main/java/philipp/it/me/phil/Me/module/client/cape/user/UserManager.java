...
import philipp.it.me.phil.Me.module.client.cape.DevCapes;
import philipp.it.me.phil.Me.module.client.cape.cape.CapeManager;
...
public class UserManager {
    ...
    public User parse(String user, Object cape) {
        ...
        if (capeInstance != null) {
            ...
            DevCapes.logger.error(String.format("Error parsing cape, %s", cape));
        }
